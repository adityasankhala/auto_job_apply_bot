"""
Internshala Auto Applier - Tkinter UI

Run:  python3 -m internshala_bot.app

Flow: Open Chrome -> set filters + log in on internshala.com -> Start Applying.
...
from internshala_bot import main as bot
...
class App:
    ...
    def _build(self):
        r = self.root
        r.title("Internshala Auto Applier")
        r.geometry("860x640")
        r.configure(bg=BG)
        r.minsize(700, 500)
        ...
        tk.Label(header, text="Internshala Auto Applier", bg=BG, fg=FG,
        ...
        try:
            while True:
                ...
                if kind == "log":
                    ...
                    self._set_status("Chrome is open — log in & set your filters on "
                                     "internshala.com, then click “Start Applying”.", GREEN)
