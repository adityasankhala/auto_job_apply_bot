"""
Naukri Auto Applier - Tkinter UI

Run:  python3 -m naukri_bot.app  

Flow: Open Chrome -> log in + set filters on naukri.com -> Start Applying.
...
from naukri_bot import main as bot
...
class App:
    ...
    def _build(self):
        ...
        tk.Label(header, text="Naukri Auto Applier", bg=BG, fg=FG,
            ...
            while True:
                ...
                if kind == "log":
                    ...
                    self._set_status("Chrome is open — log in and set filters on "
                                     "naukri.com, then click “Start Applying”.", GREEN)
