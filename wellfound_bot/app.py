"""
Wellfound Auto Applier - Tkinter UI

Run:  python3 -m wellfound_bot.app  

Flow: Open Chrome -> log in + set filters on wellfound.com -> Start Applying.
...
from wellfound_bot import main as bot
...
class App:
    ...
    def _build(self):
        r = self.root
        r.title("Wellfound Auto Applier")
        r.geometry("860x640")
        r.configure(bg=BG)
        r.minsize(700, 500)
        ...
        tk.Label(header, text="Wellfound Auto Applier", bg=BG, fg=FG,
            ...
            while True:
                ...
                if kind == "log":
                    ...
                    self._set_status("Chrome is open — log in and set filters on "
                                     "wellfound.com, then click “Start Applying”.", GREEN)
